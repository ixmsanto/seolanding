  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="absolute inset-0 grid place-content-center bg-gradient-to-br from-indigo-500 to-violet-500 text-white"  // Change bg to black here
      >
